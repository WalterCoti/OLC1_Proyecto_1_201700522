...
"%%" {return new Symbol(sym.SEPA,yycolumn,yyline, yytext());}
"->" {return new Symbol(sym.ASIGN,yycolumn,yyline, yytext());}
";" {return new Symbol(sym.PTCOMA,yycolumn,yyline, yytext());}
":" {return new Symbol(sym.DDOT,yycolumn,yyline, yytext());}
"." {return new Symbol(sym.DOT,yycolumn,yyline, yytext());}
"," {return new Symbol(sym.COMA,yycolumn,yyline, yytext());}
"{" {return new Symbol(sym.LLAVEL,yycolumn,yyline, yytext());} 
"}" {return new Symbol(sym.LLAVER,yycolumn,yyline, yytext());}
"|" {return new Symbol(sym.DISYUN,yycolumn,yyline, yytext());}
"?" {return new Symbol(sym.SINTER,yycolumn,yyline, yytext());}
"+" {return new Symbol(sym.MAS,yycolumn,yyline, yytext());}
"*" {return new Symbol(sym.POR,yycolumn,yyline, yytext());}
"~" {return new Symbol(sym.VIRGU,yycolumn,yyline, yytext());}
